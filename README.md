...
- 本仓库：面向 AI 工作台/智能体（WorkBuddy、OpenClaw、Claude 系等）的分发壳。技能本体在 [`skills/deskpeto/SKILL.md`](skills/deskpeto/SKILL.md)。
...
| OpenClaw | `clawhub install deskpeto`；或把 `skills/deskpeto/` 放入 OpenClaw 的 skills 目录 |
